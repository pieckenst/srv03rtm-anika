...
int PID_setup_key(CWPAHyperellipticParams *arg_0, CWPAShortSigKey **arg_4)
{
  ...
  if ( v66 )
  {
    ...
    else
    {
      ...
      v73->dword35E8.coefs = v63;
      v63 += (v74 + 1) * lngp;
      v73->pvoid363C[0].maxlength = 2 * v74 + 2;
      v73->pvoid363C[0].coefs = v63;
      v63 += (2 * v74 + 2) * lngp;
      v73->pvoid363C[1].maxlength = 2 * v74 + 2;
      v73->pvoid363C[1].coefs = v63;
      v63 += (2 * v74 + 2) * lngp;
      for ( i = 0; i != v74; ++i )
      {
        v73->kp_struc35F4[i].maxlength = v74;
        v73->kp_struc35F4[i].coefs = v63;
        v63 += v74 * lngp;
        for ( j = 0; j != v74; ++j )
        {
          v73->pvoid3618[i][j] = v63;
          v63 += lngp;
        }
      }
      v73->pvoid3654[0] = v63;
  ...
  if ( v66 )
  {
    dwords_to_digits(arg_0->pModulus, v73->punsigned1C, v70);
    if ( !test_primality(v73->punsigned1C, lngp) )
      v66 = 0;
    divide_immediate(v73->punsigned1C, 2u, 0, v73->punsigned28, lngp);
    multiply(v73->punsigned1C, lngp, v73->punsigned1C, lngp, v73->punsigned30);
    multiply(v73->punsigned1C, lngp, v73->punsigned30, 2 * lngp, v73->punsigned34);
    divide_immediate(v73->punsigned30, 2u, 0, v73->punsigned2C, 2 * lngp);
    sub_diff(v73->punsigned30, 2 * lngp, v73->punsigned1C, lngp, v73->punsigned30);
    sub_diff(v73->punsigned34, 3 * lngp, v73->punsigned1C, lngp, v73->punsigned34);
    divide_immediate(v73->punsigned30, 2u, 0, v73->punsigned30, 2 * lngp);
    divide_immediate(v73->punsigned34, 3u, 0, v73->punsigned34, 3 * lngp);
    memcpy(v73->pvoid20, v73->punsigned1C, 4 * lngp);
    for ( i = 2; i <= v74; ++i )
    {
      unsigned int lnga; // [sp+2F0h] [bp-40h]@49
      lnga = (i - 1) * lngp;
      memcpy(v73->pvoid363C[0].coefs, v73->pvoid20, 4 * lnga);
      multiply(v73->pvoid363C[0].coefs, lnga, v73->punsigned1C, lngp, v73->pvoid20);
    }
    v66 = v66 && mp_shift(v73->pvoid20, -1, v73->pvoid20, lng) == 1;
    if ( v74 == 3 )
    {
      v66 = v66 && !add_immediate(v73->pvoid20, 1u, v73->punsigned24, lng);
      v66 = v66 && !mp_shift(v73->punsigned24, -1, v73->punsigned24, lng);
    }
  }
  v66 = v66 && create_modulus(v73->punsigned1C, lngp, 0, &v73->mp_modulus40);
  ...
  if ( v66 )
  {
    ...
    if ( v66 )
    {
      v66 = v66 && Kimmediate(v60, v73->dword38, &v73->kstruc1284);
      v66 = v66 && Kinvert(v73->dword38, v73->dword3C, &v73->kstruc1284);
    }
    }
  }
  v75 = v66;
  if ( v66 && v74 == 3 )
  {
    ...
    {
      v66 = v66
         && KPexpon(&v73->kp_struc35F4[i - 1], v73->punsigned1C, lngp, &v73->kp_struc35F4[i], &v73->dword35E8, arg_C);
  ...
  if ( v66 && v74 == 3 )
  {
    ...
    for ( i = 0; v66 && i != v74; ++i )
    {
      ...
      {
        v66 = v66 && Kclear(ptr[i], 2 * v74, v53);
        v66 = v66 && Kcopy(v53->one, &ptr[i][(i + v74) * lngp], 1, v53);
      }
    }
    for ( i = 0; v66 && i != v74; ++i )
    {
      ...
      if ( v51 != (DWORD)-1 )
      {
        for ( k = 0; k <= v51; ++k )
        {
          v66 = v66 && Kcopy(&v50->coefs[k * lngp], &ptr[k][i * lngp], 1, v53);
        }
      }
      }
    }
    for ( i = 0; v66 && i != v74; ++i )
    {
      ...
      else
      {
        ...
        ptr[v49] = ptr[i];
        ptr[i] = v48;
        v66 = v66 && Kinvert(&v48[i * lngp], v47, v53);
        for ( k = i; k != 2 * v74; ++k )
        {
          v66 = v66 && Kmul(&v48[k * lngp], v47, &v48[k * lngp], v53);
        }
        for ( j = 0; v66 && j != v74; ++j )
        {
          if ( j != i )
          {
            v66 = v66 && Kcopy(&ptr[j][i * lngp], v47, 1, v53);
            for ( k = i; k != 2 * v74; ++k )
            {
              v66 = v66 && Kmulsubfrom(v47, &v48[k * lngp], &ptr[j][k * lngp], &ptr[j][k * lngp], v53);
            }
          }
        }
        }
    ...
    for ( i = 0; i != v74; ++i )
    {
      for ( k = 0; k != v74; ++k )
      {
        v66 = v66 && Kcopy(&ptr[i][(k + v74) * lngp], v73->pvoid3618[i][k], 1, v53);
      }
    }
    for ( i = 0; i != v74; ++i )
    {
  ...
  if ( v66 )
  {
    ...
    for ( i = 0; v66 && i <= 2 * v74 + 1; ++i )
    {
      ...
      b = &v73->pvoid363C[0].coefs[i * lngp];
      v33 = &v73->pvoid363C[1].coefs[i * lngp];
      dwords_to_digits(&arg_0->pCurveCoefficients[i * v70], a1, v70);
      to_modular(a1, lngp, b, v35);
      if ( v74 == 2 )
      {
        v66 = v66 && Kcopy(b, v33, 1, v46);
      }
      else
      {
        v66 = v66 && Knegate(b, v33, v46);
      }
    }
  ...
  for ( i = 0; v66 && i != 2; ++i )
  {
    ...
    v32 = v73->dword14;
    dwords_to_digits(arg_0->field_24[i], v73->pvoid3654[i], v76);
    if ( v74 == 2 )
      memcpy(v73->pvoid3654[1], v73->pvoid3654[0], 4 * lngb);
    if ( !all_zero(v73->pvoid3654[i], lngb) )
    {
      digit_t gcd[6]; // [sp+74h] [bp-2BCh]@246

      v31 = mp_gcdex(&v32, 1u, v73->pvoid3654[i], lngb, v73->dword365C[i], 0, gcd, 0);
...
int sub_1061A54(const kpoly_t *a1, const kpoly_t *a2, kpoly_t *a3, const CWPAShortSigKey *a4, int *a5)
{
  ...
  v41 = &a4->kstruc1284;
  v32 = a4->dword8;
  v42 = mp_significant_bit_count(a4->punsigned2C, 2 * v32);
  *a5 = 0;
  v39.maxlength = 6;
  v39.coefs = v38;
  v33.maxlength = 6;
  ...
  v25.maxlength = 2;
  v25.coefs = v35;
  v28 = v28 && KPexpon(a1, a4->punsigned2C, 2 * v32, &v39, a2, v41);
  if ( !v28 )
  {
  }
  ...
  for ( i = 0; i < 0x64 && v28 && !v37; ++i )
  {
    ...
    for ( j = v42 - 1; v28 && j != (DWORD)-1; --j )
    {
      ...
      v23 = mp_getbit(a4->punsigned2C, j);
...
int sub_10631F8(digit_tc a1[], DWORD a2, const CWPAShortSigKey *a3, BYTE *a4)
{
  ...
  for ( i = 0; i != a2 && v22; ++i )
  {
    DWORD v20 = a[i / RADIX_BYTES] >> (8 * (i % RADIX_BYTES));
    a4[i] = (BYTE)v20;
  }
  return v22;
  }}}}}}}}
...
int sub_106356D(digit_tc a1[], const CWPAShortSigKey *a2, digit_t a3[])
{
  ...
  v4 = b + lnga;
  a = &v4[lnga];
  multiply(a, lnga, a, lnga, c);
  multiply(a, lnga, c, 2 * lnga, a3);
  sub_diff(a3, 3 * lnga, a, lnga, a3);
  divide_immediate(a3, 3u, 0, a3, 3 * lnga);
  multiply(v4, lnga, a, lnga, c);
...
int sub_106370F(const kpoly_t *a1, const CWPAShortSigKey *a2, digit_t a3[])
{
  ...
  lnga = v37 * v35;
  a6 = &a2->kstruc1284;
  v40 = mp_significant_bit_count(a2->pvoid20, lnga);
  v31 = 100;
  v34 = 1;
  v32 = 0;
      ...
      if ( v32 )
      {
        ...
        for ( i = 0; i != v37; ++i )
        {
          for ( j = 0; j != v37; ++j )
          {
            ...
            v34 = v34 && Kmul(a2->pvoid3618[i][j], &v23[j * v35], v22, a6);
            v34 = v34 && Kadd(&a3[i * v35], v22, &a3[i * v35], a6);
          }
          from_modular(&a3[i * v35], &a3[i * v35], &a2->mp_modulus40);
        }
      }
    }
    }}}}
...
int sub_1064941(const kpoly_t *a1, const CWPAShortSigKey *a2, digit_t a3[])
{
  ...
  v16 = v16 && Kmul(c, a2->dword3C, c, v18);
  ...
  if ( v16 )
  {
    ...
    v16 = v16 && !sub_same(a2->punsigned1C, a, c, lng);
    if ( compare_same(a, c, lng) > 0 )
      memcpy(a, c, sizeof(digit_t) * lng);
    v16 = v16 && !sub_immediate(a, 1, a, lng);
    multiply(a, lng, a2->punsigned1C, lng, a3);
    v16 = v16 && !add_diff(a3, 2 * lng, b, lng, a3);
    v16 = v16 && compare_same(a3, a2->punsigned30, 2 * lng) < 0;
  }
  return v16;
  }}}}}}}
}
...
BOOL __stdcall sub_1064D6C(const shortsig00_struc_1 *a1, const CWPAShortSigKey *a2, shortsig00_struc_1 *a3)
{
  ...
  v7 = a1->field_50;
  v6 = v6 && (v7 == 0 || v7 == 1);
  v6 = v6 && sub_10621B2(a1, &v8, 1, a2, a3);
  return v6;
  }}}
}
...
int sub_1064DFC(digit_tc a1[], const CWPAShortSigKey *a2, shortsig00_struc_1 *a3, int* a4)
{
  ...
  *a4 = 1;
  ...
  v38.coefs = v34;
  v29 = v29 && v33 == 2;
  v29 = v29 && sub_10619F5(a3, a2);
  a3->field_50 = a3a;
  v29 = v29 && sub_106241C(a3, a2, a3a);
  add_immediate(a2->punsigned1C, 1u, denom, lden);
  divide(a1, 2 * lden, denom, lden, 0, quot[0], quot[1]);
  if ( compare_same(quot[0], a2->punsigned1C, lden) <= 0 )
  {
    int v28; // [sp+B0h] [bp-60h]@14
    v28 = compare_same(quot[1], quot[0], lden) >= 0;
    for ( i = 0; v29 && i != 2; ++i )
    {
      if ( compare_same(quot[i], a2->punsigned1C, lden) )
      {
  ...
  else
  {
    ...
    v29 = v29 && Kmul(v25, a2->dword38, v25, v39);
