...
extern "C" int GetSafeMode(DWORD* arg_0) {
	ULONG var_4, var_8;
	var_4 = 0xE7A;
...
extern "C" DWORD sub_1043104(DWORD timerId, DWORD* val) {
	if (val) {
		*val = 0;
	}
	DWORD esi = 0x88933;
...
extern "C" DWORD sub_10432CC(int arg_0, int arg_4) {
	DWORD edx = 0x88933;
	DWORD ecx = edx;
...
extern "C" DWORD CALLBACK sub_1045263(LPVOID ThreadParam) {
...
extern "C" HRESULT GetReminder(DWORD* arg_0) {
	AutoHKEY var_18;
	DWORD cbData;
	DWORD Data = 0;
	DWORD Type = 4;
...
extern "C" void sub_10461F2(DWORD arg_0, DWORD arg_4, DWORD arg_8) {
	DWORD dwDisposition;
#ifdef _X86_
	__asm {
                push    eax
...
extern "C" DWORD CALLBACK sub_10470D2(LPVOID arg_0) {
#ifdef _X86_
	__asm   push    eax
...
extern "C" HRESULT ExtendGracePeriod(CWPALicenseManager* arg_0) {
...
extern "C" int sub_10479E9(PDWORD arg_0, PDWORD arg_4, BOOL arg_8) {
	COOBETimer Data;
	CWPATimes var_A8;
#ifdef _X86_
	__asm {
...
extern "C" HRESULT sub_1047F5F(HANDLE hUserToken, LPWSTR lpDesktop) {
...
extern "C" BOOL sub_10498CE(void) {
	DWORD var_4 = 0;
	DWORD cbNeeded = 0;
	DWORD var_10 = 0x400;
...
extern "C" HRESULT sub_1049CA1(HDESK arg_0, HDESK arg_4, LPWSTR arg_8, LPVOID arg_C, HANDLE hUserToken, HWND hWnd, int arg_18, int arg_1C, DWORD* arg_20, DWORD* arg_24, DWORD* arg_28) {
	DWORD var_4 = 0;
