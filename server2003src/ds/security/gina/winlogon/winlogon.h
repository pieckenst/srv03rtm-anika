...
#define WL_NOTIFY_DISCONNECT         10
#define WL_NOTIFY_RECONNECT          11
#define WL_NOTIFY_MAX 12

typedef struct _TERMINAL *PTERMINAL;

typedef BOOL (*WL_SHOULD_NOTIFY_SYNC)(PTERMINAL pTerm);
...
typedef struct _MUGLOBALS {
    ...
    BOOL field_E70;
    int field_E74;
    ExtendedClientCredentials Credentials;
...
#ifndef __cplusplus // in C++ some COM interfaces have GetState() method
...
typedef struct _TERMINAL {
    ...
    DWORD   ErrorMode ;
    DWORD   SmartCardTid ;
    enum _SC_EVENT_TYPE CurrentScEvent ;
    struct _SC_DATA*   CurrentScData ;
    CRITICAL_SECTION CurrentScCritSect;
    //
...
extern BOOL      bReconEventSignalled;
extern BOOL      bAttemptAutoReconnect;
extern BOOL      ShutdownInProgress;
extern BOOL      ShutdownHasBegun;
extern HANDLE    g_hDeferredTSNotifyThread;
extern BOOL      g_FUSUserLoggedOff;
extern BOOL      g_UnlockedDuringDisconnect;
extern BOOL      g_fWaitForSwitchUser;
extern BOOL      g_fWaitForLockWksMsgFromWin32k;
